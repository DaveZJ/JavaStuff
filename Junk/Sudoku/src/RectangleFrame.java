		...
		class verifyButtonListener implements ActionListener
		{
			public void actionPerformed(ActionEvent event)
			{
				...
				if(csum == 0)
				{
					...
					JLabel textLabelBox = new JLabel("Sudoku verified!");
					JPanel apanelBox = new JPanel();
					apanelBox.add(textLabelBox);
					frameBox.setContentPane(apanelBox);
					frameBox.pack();
					//frameBox.show();
				}
				else
				{
					JFrame frameBox = new JFrame();
					JLabel textLabelBox = new JLabel("Bad sudoku!");
					JPanel apanelBox = new JPanel();
					//JButton okButton = new JButton("Ok");
					apanelBox.add(textLabelBox);
					frameBox.setContentPane(apanelBox);
