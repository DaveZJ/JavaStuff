		...
		class forceButtonListener implements ActionListener
		{
			public void actionPerformed(ActionEvent event)
			{
				...
				*/
				...
				IIField.setText("" + TheSet.isSubset(BIField.getText()));
				*/

				/*
				OrdSet TheSet = new OrdSet();
				TheSet.fillSet(AIField.getText());
				IIField.setText(TheSet.PermSet(3));
				*/

				int[][] TestListI = new int[9][9];
				TestListI[0][0] = 7;
				int[][] TestListII = new int[9][9];
				TestListII = TestListI; 
				AIField.setText("" + TestListII[0][0]);
